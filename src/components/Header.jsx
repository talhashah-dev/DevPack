    ...
    <header className="bg-white">
      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
            ...
            <Link to="/blog" className="text-sm font-semibold leading-6 text-gray-900">Blog</Link>            
        </PopoverGroup>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <Link to="/blog" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Blog</Link>            
              </div>
              <div className="py-6">
